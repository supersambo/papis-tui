...
Modifications allow to use keys mapped to either
scroll_up, scroll_down, jump_to_top or jump_to_bottom
...
class Screen(object):
    ...
    def __init__(self, items):
        ...
        config = get_config()
        km = ["scroll_down", "scroll_up", "page_up", "page_down"]
    ...
    def input_stream(self):
        ...
        while True:
            ...
            if self.km.check("scroll_down", key):
                ...
                self.scroll(self.UP)
            elif self.km.check("page_up", key):
                self.paging(self.UP)
            elif self.km.check("page_down", key):
